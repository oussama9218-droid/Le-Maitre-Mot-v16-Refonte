...
class GM07Family(str, Enum):
    """Familles d'exercices GM07"""
...
GM07_EXERCISES: List[Dict[str, Any]] = [
    ...
    # =========================================================================
    {
        ...
        "solution_html": "<h4>Correction détaillée</h4><ol><li>L'aiguille des heures pointe vers le **12**.</li><li>L'aiguille des minutes est sur le 3, ce qui correspond à $3 \\times 5 = 15$ minutes.</li><li>L'heure affichée est **12h15**.</li></ol><p style=\"color: orange;\"><strong>Piège classique (facile) :</strong> Ne confondez pas l'aiguille des heures et celle des minutes, surtout quand l'aiguille des minutes est sur un nombre (ex: le 3 pour 15 min).</p>",
        "needs_svg": True
    },
    {
        "id": 2,
        ...
        "solution_html": "<h4>Correction détaillée</h4><ol><li>L'heure indiquée est en soirée, nous utilisons le format 24h. L'aiguille des heures se rapproche du 6 (pour 18h).</li><li>L'aiguille des minutes indique la 47ème minute, soit **47 min**.</li><li>L'heure complète est **17h47**.</li></ol>",
        "needs_svg": True
    },
    {
        "id": 3,
        ...
        "solution_html": "<h4>Correction détaillée</h4><ol><li>**Aiguille des minutes :** Elle pointe exactement vers la 53ème graduation après le 12 (légèrement après le 10 sur le cadran).</li><li>**Aiguille des heures :** Elle a fait $\\frac{53}{60}$ du trajet entre le 9 et le 10. Elle est donc **très proche du 10**, mais ne l'a pas encore atteint.</li><li>L'heure affichée est **09h53**.</li></ol><p style=\"color: orange;\"><strong>Piège classique (difficile) :</strong> Quand l'heure est proche de l'heure pile suivante (ex: 09h53), l'aiguille des heures doit être très avancée. L'élève doit comprendre la rotation continue.</p>",
        "needs_svg": True
    },
    {
        "id": 4,
        ...
        "solution_html": "<h4>Correction détaillée</h4><ol><li>L'aiguille des minutes est sur le 9, ce qui signifie $9 \\times 5 = 45$ minutes.</li><li>L'aiguille des heures est **avant le 4**, l'heure est donc 3 heures et 45 minutes.</li><li>Puisque l'on suppose l'après-midi, on ajoute 12 heures : $3 \\text{ h} + 12 \\text{ h} = 15 \\text{ h}$.</li><li>L'heure affichée est **15h45**.</li></ol>",
        "needs_svg": True
    },
    {
        "id": 5,
        ...
        "solution_html": "<h4>Correction détaillée</h4><ol><li>L'aiguille des heures est sur le **7**.</li><li>L'aiguille des minutes est sur le 12, ce qui signifie 00 minute.</li><li>L'heure affichée est **07h00**.</li></ol>",
        "needs_svg": True
    },
    {
        "id": 6,
        ...
        "difficulty": "facile",
        "offer": "free",
        "enonce_html": "<p><strong>Conversion simple (h vers min) :</strong> Le cours de technologie de Monsieur Martin dure **3 heures**. Exprime cette durée uniquement en minutes.</p>",
        "solution_html": "<h4>Correction détaillée</h4><ol><li>On sait que $1 \\text{ h} = 60 \\text{ min}$.</li><li>On effectue la multiplication : $3 \\times 60 = 180$.</li><li>La durée est de **180 minutes**.</li></ol>",
        "needs_svg": False
    },
    {
        "id": 7,
        ...
        "difficulty": "moyen",
        "offer": "free",
        "enonce_html": "<p><strong>Conversion min vers h et min :</strong> Le temps passé par un athlète à courir est de **215 minutes**. Convertis cette durée en heures et minutes.</p>",
        "solution_html": "<h4>Correction détaillée</h4><ol><li>On cherche combien de fois 60 minutes (1 heure) sont contenues dans 215 minutes.</li><li>$215 \\div 60$. On trouve $3$ heures ($3 \\times 60 = 180$).</li><li>On calcule le reste : $215 - 180 = 35$ minutes.</li><li>La durée est de **3 h 35 min**.</li></ol>",
        "needs_svg": False
    },
    {
        "id": 8,
        ...
        "difficulty": "moyen",
        "offer": "free",
        "enonce_html": "<p><strong>Conversion composée (h, min vers sec) :</strong> Un élève a mis **1 heure, 10 minutes et 30 secondes** pour faire ses devoirs. Convertis cette durée totale en secondes.</p>",
        "solution_html": "<h4>Correction détaillée</h4><ol><li>Conversion des heures : $1 \\text{ h} = 1 \\times 3600 = 3600$ secondes.</li><li>Conversion des minutes : $10 \\text{ min} = 10 \\times 60 = 600$ secondes.</li><li>Addition de toutes les secondes : $3600 + 600 + 30 = 4230$.</li><li>La durée totale est de **4230 secondes**.</li></ol>",
        "needs_svg": False
    },
    {
        "id": 9,
        ...
        "difficulty": "difficile",
        "offer": "free",
        "enonce_html": "<p><strong>Piège de l'heure décimale (h vers h et min) :</strong> Un système informatique indique qu'un processus a duré **2,75 heures**. Convertis cette durée en heures et minutes.</p>",
        "solution_html": "<h4>Correction détaillée</h4><ol><li>La partie entière est 2, soit **2 heures**.</li><li>La partie décimale est 0,75. Il faut la convertir en minutes en multipliant par 60.</li><li>Calcul : $0,75 \\times 60 = 45$.</li><li>La durée est de **2 h 45 min**.</li></ol><p style=\"color: orange;\"><strong>Piège classique (difficile) :</strong> Attention ! $0,75 \\text{ h}$ n'est PAS $75$ minutes. Les élèves doivent comprendre que le temps n'est pas en base 100.</p>",
        "needs_svg": False
    },
    {
        "id": 10,
        ...
        "difficulty": "facile",
        "offer": "free",
        "enonce_html": "<p><strong>Conversion inverse (sec vers min) :</strong> Une chanson dure **300 secondes**. Exprime cette durée uniquement en minutes.</p>",
        "solution_html": "<h4>Correction détaillée</h4><ol><li>On sait que $60 \\text{ secondes} = 1 \\text{ minute}$.</li><li>On effectue la division : $300 \\div 60 = 5$.</li><li>La durée est de **5 minutes**.</li></ol>",
        "needs_svg": False
    },
    ...
    # =========================================================================
    {
        ...
        "difficulty": "moyen",
        "offer": "pro",
        "enonce_html": "<p><strong>Calcul de durée simple avec report :</strong> Quelle est la durée d'un vol qui décolle à **14h40** et atterrit à **17h05** ? (Format X h Y min)</p>",
    ...
    },
    {
        ...
        "difficulty": "moyen",
        "offer": "pro",
        "enonce_html": "<p><strong>Calcul de durée sans passage de jour :</strong> Un documentaire sur la nature commence à **18h10** et se termine à **21h55**. Quelle est la durée totale du documentaire ? (Format X h Y min)</p>",
...
def get_gm07_exercises(
    ...
    """
    Retourne les exercices GM07 filtrés par offer et difficulty.
    ...
    if offer == "pro":
        ...
        filtered = GM07_EXERCISES.copy()
    else:
        # Free ne voit que les exercices free
        filtered = [ex for ex in GM07_EXERCISES if ex["offer"] == "free"]
...
def get_random_gm07_exercise(
    ...
    """
    Retourne un exercice GM07 aléatoire selon les filtres.
