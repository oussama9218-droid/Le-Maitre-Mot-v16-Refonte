...
class IAOptimizationTester:
    ...
    def safe_get_text(self, obj, key='enonce', default=''):
        """Safely get text from an object, handling both dict and string cases"""
    ...
    def test_symetrie_axiale_optimization(self):
        ...
        test_data = {
            ...
            "niveau": "6e",  # Symétrie axiale is available for 6e
        ...
        if success and isinstance(response, dict):
            ...
            enonces = [self.safe_get_text(ex, 'enonce') for ex in exercises]
            ...
            avg_content_score = geometric_content_score / (len(exercises) * 3) if exercises else 0
            print(f"\n📐 CONTENU GÉOMÉTRIQUE:")
    ...
    def test_symetrie_centrale_optimization(self):
        ...
        test_data = {
            "matiere": "Mathématiques",
            "niveau": "5e",  # Symétrie centrale is available for 5e
        ...
        if success and isinstance(response, dict):
            ...
            for i, exercise in enumerate(exercises):
                enonce = self.safe_get_text(exercise, 'enonce')
