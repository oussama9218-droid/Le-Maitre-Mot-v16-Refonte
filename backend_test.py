...
class LeMaitreMotAPITester:
    def __init__(self, base_url="https://lemaitremot-2.preview.emergentagent.com"):
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        if test_mode == "math":
            ...
            print("Available modes: math, curriculum, newsubjects, auth, logo, magic, security, template, subscription, feature_flags, urgent, coherence")
        sys.exit(0)
