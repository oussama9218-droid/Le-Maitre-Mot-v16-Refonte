...
curl -X GET "https://mathalea-svg.preview.emergentagent.com/api/mathalea/pro/config" \
...
- API_BASE_URL : `https://mathalea-svg.preview.emergentagent.com`
- Résultat : `https://mathalea-svg.preview.emergentagent.com/uploads/logos/abc123.png`
