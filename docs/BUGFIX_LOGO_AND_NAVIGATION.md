...
curl -X GET "https://exerrchive.preview.emergentagent.com/api/mathalea/pro/config" \
...
- API_BASE_URL : `https://exerrchive.preview.emergentagent.com`
- Résultat : `https://exerrchive.preview.emergentagent.com/uploads/logos/abc123.png`
