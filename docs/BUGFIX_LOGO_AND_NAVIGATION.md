...
curl -X GET "https://math-admin-hub.preview.emergentagent.com/api/mathalea/pro/config" \
...
- API_BASE_URL : `https://math-admin-hub.preview.emergentagent.com`
- Résultat : `https://math-admin-hub.preview.emergentagent.com/uploads/logos/abc123.png`
