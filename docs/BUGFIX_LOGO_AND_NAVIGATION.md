...
curl -X GET "https://mathalea-export.preview.emergentagent.com/api/mathalea/pro/config" \
...
- API_BASE_URL : `https://mathalea-export.preview.emergentagent.com`
- Résultat : `https://mathalea-export.preview.emergentagent.com/uploads/logos/abc123.png`
