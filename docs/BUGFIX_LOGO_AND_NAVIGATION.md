...
curl -X GET "https://mathworksheets.preview.emergentagent.com/api/mathalea/pro/config" \
...
- API_BASE_URL : `https://mathworksheets.preview.emergentagent.com`
- Résultat : `https://mathworksheets.preview.emergentagent.com/uploads/logos/abc123.png`
